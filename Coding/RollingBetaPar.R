...
collectRegressionData = foreach(iSymbol = 1:dim(allSymbols)[1], .combine=rbind , .packages = parPackages ) %dopar% 
{
  ...
  thisSymbol2 = allReturnsData %>%
                ...
                ungroup() %>%
                dplyr::select(SymbolDesc,YearMonth,SymbolRet,MarketRet,OilRet) %>%
...
save(collectRegressionData,file="C:/Users/giles/OneDrive/MBA/Dissertation/Data/RollingBeta.Rdata")
#save(collectRegressionData,file="C:/Users/giles/OneDrive/MBA/Dissertation/Data/RollingBetaMonthly_TempCheck.Rdata")
