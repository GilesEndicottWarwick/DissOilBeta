...
allReturns_S1 = Skeleton_1 %>%
  ...
  group_by(Symbol,SymbolDesc,Industry,SubIndustry,Year) %>%
...
IndustryReturnsDataWithOil_OUT_Annual = IndustryReturnsDataWithOil %>%
...
save(IndustryReturnsDataWithOil_OUT_Annual,file="C:/Users/giles/OneDrive/MBA/Dissertation/Data/MonthlyIndustryReturnsAnnual.Rdata");
