...
allReturns_S2 = allReturns_S1 %>%
  ...
  group_by(Industry,Year,BiWeek,Date) %>%
  summarise(
...
IndustryReturnsDataWithOil_OUT_BiWeekly = IndustryReturnsDataWithOil %>%
...
save(IndustryReturnsDataWithOil_OUT_BiWeekly,file="C:/Users/giles/OneDrive/MBA/Dissertation/Data/MonthlyIndustryReturnsBiWeekly.Rdata");
